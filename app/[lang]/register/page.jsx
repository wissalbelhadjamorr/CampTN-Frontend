        ...
        <div className="basis-1/2 w-full relative hidden xl:flex justify-center items-center bg-card">
          ...
          <div className="relative z-10 text-center space-y-6 max-w-[500px] px-12">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Créez votre compte et commencez à explorer les plus beaux
            ...
            <div className="flex flex-col gap-3 pt-2">
              {[
                ...
                { icon: "⚡", title: "Accès immédiat", desc: "Réservez dès la création de votre compte" },
                { icon: "💚", title: "100% Gratuit", desc: "Aucun frais d'inscription, profitez librement" },
              ].map((feature) => (
                <div
                  key={feature.title}
